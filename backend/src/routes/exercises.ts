...
export async function exerciseRoutes(fastify: FastifyInstance) {
  ...
  // Get exercise by ID
  fastify.get<{ Params: { id: string } }>('/exercises/:id', async (request, reply) => {
    try {
  ...
  // Create new exercise
  fastify.post<{ Body: CreateExerciseRequest }>('/exercises', async (request, reply) => {
    try {
  ...
  // Delete exercise
  fastify.delete<{ Params: { id: string } }>('/exercises/:id', async (request, reply) => {
    try {
      const { id } = request.params;
  ...
  fastify.get<{ Params: { category: string } }>('/exercises/category/:category', async (request, reply) => {
    try {
  ...
  fastify.get<{ Querystring: { muscle: string } }>('/exercises/search', async (request, reply) => {
    try {
